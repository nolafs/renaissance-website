...
module.exports = {
  ...
  resolve: {
    alias: {
      "TweenLite": path.resolve('node_modules', 'gsap/dist/gsap'),
      "TweenMax": path.resolve('node_modules', 'gsap/dist/gsap'),
      "TimelineLite": path.resolve('node_modules', 'gsap/dist/gsap'),
      "TimelineMax": path.resolve('node_modules', 'gsap/dist/gsap'),
