(function (global, factory) {
  ...
  */
  ...
  _relExp = /[\+-]=-?[\.\d]+/,
    ...
    return typeof console !== "undefined" && console.warn(message);
  },
  ...
  */
  _addToTimeline = function _addToTimeline(timeline, child, position) {
    ...
    return _conditionalReturn(!returnFunction, function () {
  ...
  */
  ...
  function () {
    ...
    _proto.totalTime = function totalTime(_totalTime, suppressEvents) {
      ...
      var parent = this.parent || this._gc,
          start;
      ...
      if (parent && parent.smoothChildTiming && this._ts) {
        ...
        if (!this.parent) {
          //if the animation doesn't have a parent, put it back into its last parent (recorded as _gc for exactly cases like this).
  ...
  function (_Animation2) {
    ...
    function Tween(targets, vars, time) {
      ...
      _this4._targets = parsedTargets.length ? _harness(parsedTargets) : _warn("Cannot tween a null target") || [{}];
      ...
      if (keyframes || stagger || _isFuncOrString(duration) || _isFuncOrString(delay)) {
        ...
        if (keyframes) {
          ...
          for (i = 0; i < l; i++) {
            ...
            copy.duration = +_parseFuncOrString(vars.duration, _assertThisInitialized(_this4), i, curTarget, parsedTargets);
            copy.delay = +_parseFuncOrString(vars.delay, _assertThisInitialized(_this4), i, curTarget, parsedTargets) || 0;
      ...
      if (immediateRender || !duration && !keyframes && _this4._start === _this4.parent._time && _isNotFalse(immediateRender)) {
